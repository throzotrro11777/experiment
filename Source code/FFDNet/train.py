...
def prepare_data():
    params = []
    for img_ in os.listdir('/home/liyu/data/denoiseing/exploration_database_and_code/'):
        params.append(f'/home/liyu/data/denoiseing/exploration_database_and_code/{img_}')
    with Pool(90) as p:
        p.map(process_slided_image, tqdm(params))


def process_slided_image(param):
    shutil.move(param, f'{param.split(".")[0]}.jpg')
