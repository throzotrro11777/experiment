...
def test():
    ...
    gen.load_state_dict(torch.load("saved_model/Gen_200.pth"))
    ...
    data_process_steps = [
            ...
            transforms.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5]),  # 彩色图像归一化
        ]
    ...
    for i, batch in enumerate(test_data):
        ...
        save_image(image_grid, f"test_image/{i},PSNR={psnr:.4f},SSIM={ssim:.4f}.png", normalize=False)
